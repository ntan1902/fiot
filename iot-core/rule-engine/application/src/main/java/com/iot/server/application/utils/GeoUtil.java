...
import com.iot.server.application.action.geo.Coordinates;
import com.iot.server.application.action.geo.RangeUnit;
...
public class GeoUtil {
  ...
  private static Geometry buildPolygonFromCoordinates(List<Coordinate> coordinates) {
    if (coordinates.size() == 2) {
      ...
      coordinates.addAll(Arrays.asList(a, b, c, d, a));
    }
