import {
  REACT_APP_NODE_ENV,
  REACT_APP_DEV_AUTH_API_URL,
  REACT_APP_DEV_ENTITY_API_URL,
  REACT_APP_DEV_TRANSPORT_API_URL,
  REACT_APP_DEV_TELEMETRY_API_URL,
  REACT_APP_DEV_RULE_ENGINE_API_URL,
  REACT_APP_DEV_BASE_URL,
  REACT_APP_PROD_API_URL,
  REACT_APP_DEV_FRONT_END_URL,
} from '@env'

export const IS_DEV = REACT_APP_NODE_ENV === 'dev'

console.log('REACT_APP_NODE_ENV', REACT_APP_NODE_ENV);
...
export const BASE_URL = IS_DEV ? REACT_APP_DEV_BASE_URL : REACT_APP_PROD_API_URL

console.log('000BASE_URL', BASE_URL);
