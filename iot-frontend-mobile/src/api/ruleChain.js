...
export const RuleChainApi = {
  ...
  getRuleChain: (ruleChainId) => {
    return AxiosApi.get(
      `${API_RULE_ENGINE_SERVICE}/${API_RULE_CHAIN}/${ruleChainId}`
    )
  },
  ...
  createRuleNodes: (data) => {
    return AxiosApi.post(
      `${API_RULE_ENGINE_SERVICE}/${API_RULE_CHAIN}/${API_RULE_NODES}`,
      data
    )
  },
  ...
  getRuleNodes: (ruleChainId) => {
    return AxiosApi.get(
      `${API_RULE_ENGINE_SERVICE}/${API_RULE_CHAIN}/${ruleChainId}/${API_RULE_NODES}`
    )
  },

  getRuleNodeDescriptors: () => {
    return AxiosApi.get(
      `${API_RULE_ENGINE_SERVICE}/${API_RULE_NODE_DESCRIPTORS}`
    )
  },
