...
export const WidgetTypeApi = {
  ...
  create: (data) =>
    AxiosApi.post(`${API_ENTITY_SERVICE}/${API_WIDGET_TYPE}`, data),
  update: (id, data) =>
    AxiosApi.put(`${API_ENTITY_SERVICE}/${API_WIDGET_TYPE}s/${id}`, data),
  delete: (id) =>
    AxiosApi.delete(`${API_ENTITY_SERVICE}/${API_WIDGET_TYPE}s/${id}`),
}
