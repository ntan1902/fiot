...
export const DashboardApi = {
  ...
  create: async (data) =>
    AxiosApi.post(`${API_ENTITY_SERVICE}/${API_DASHBOARD}`, data),
  update: async (id, data) =>
    AxiosApi.put(`${API_ENTITY_SERVICE}/${API_DASHBOARD}s/${id}`, data),
  updateConfiguration: async (id, data) =>
    AxiosApi.put(
      `${API_ENTITY_SERVICE}/${API_DASHBOARD}s/${id}/configuration`,
      data
    ),
  delete: async (id) =>
    AxiosApi.delete(`${API_ENTITY_SERVICE}/${API_DASHBOARD}s/${id}`),
}
